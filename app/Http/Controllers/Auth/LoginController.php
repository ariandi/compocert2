...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        $node = Node::find(69);
        $getCompany = Company::where('Active',1)->where([['CompanyName', '!=', '']])->orderBy('CompanyName')->get();
        return view('front.auth.loginfront', ['node'=>$node, 'getCompany'=>$getCompany]);
    }

    public function storeloginfront(Request $request)
    {
        $this->validateLogin($request);
